 ...
 * @author Asus
 */
public class GameTable50_6 extends javax.swing.JFrame {

    /**
     * Creates new form GameTable50
     */
    public GameTable50_6(int noofpl,int amt[]){
        initComponents();
        this.noofpl=noofpl;
        this.amt=amt;
    }
    ...
    private void initComponents() {
        ...
        jLabel15.setBounds(610, 280, 90, 17);
        ...
        jLabel13.setBounds(420, 280, 80, 16);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                int arr[]=new int[5];
                new GameTable50_6(1,arr).setVisible(true);
            }
        });
    }
