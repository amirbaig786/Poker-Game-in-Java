 ...
 * @author Asus
 */
public class GameTable50_5 extends javax.swing.JFrame {

    /**
     * Creates new form GameTable50
     */
    public GameTable50_5(int noofpl,int amt[]){
        initComponents();
        this.noofpl=noofpl;
        this.amt=amt;
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setBounds(310, 280, 90, 17);

        jLabel11.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("10 diamonds");
        getContentPane().add(jLabel11);
        jLabel11.setBounds(220, 280, 80, 20);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                int arr[]=new int[5];
                new GameTable50_5(1,arr).setVisible(true);
            }
        });
    }
