 ...
 * @author Asus
 */
public class GameTable50_4 extends javax.swing.JFrame {

    /**
     * Creates new form GameTable50
     */
    public GameTable50_4(int noofpl,int amt[]){
        initComponents();
        this.noofpl=noofpl;
        this.amt=amt;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                int arr[]=new int[5];
                new GameTable50_4(1,arr).setVisible(true);
            }
        });
    }
